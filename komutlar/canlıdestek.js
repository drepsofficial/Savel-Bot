...
exports.run = async (client, message, params) => {
  ...
  .setTitle("» Savel BOT | Canlı Destek")
  .setDescription("**Canlı Desteği kullandğın için teşekkür ederiz, seninle ekibim ilgilenicektir lütfen bekle.**")
  .setFooter("30 Saniye içinde geri dönülmezse lütfen iletişime geçin dreps#0989 veya https://discord.gg/d7mZSK")
 message.channel.send(embed)
  ...
  .setDescription(asdf.url)
      channel.send(495648848702865409)
};
